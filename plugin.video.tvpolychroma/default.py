...
YOUTUBE_CHANNEL_ID_1 = "PL3gojy6tNZHtP2xwNxT_J_XcmsAyETfh0"
YOUTUBE_CHANNEL_ID_2 = "PL3gojy6tNZHuQYtjFn9U629OptcgXIxfz"
YOUTUBE_CHANNEL_ID_3 = "PL3gojy6tNZHsXOX0bGdFW-wRd5iOhIYAK"
...
def Main_Menu():
    ...
    Add_Dir( 
        name="Polychroma One", url=BASE+YOUTUBE_CHANNEL_ID_1+"/", folder=True,
        icon="http://polychroma.co/img/icon.png")

    Add_Dir( 
        name="Polychroma Two", url=BASE+YOUTUBE_CHANNEL_ID_2+"/", folder=True,
        icon="http://polychroma.co/img/icon.png")

    Add_Dir( 
        name="Polychroma Flow", url=BASE+YOUTUBE_CHANNEL_ID_3+"/", folder=True,
        icon="http://polychroma.co/img/icon.png")
#----------------------------------------------------------------
# A basic OK Dialog
