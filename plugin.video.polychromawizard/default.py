...
ADDON=xbmcaddon.Addon(id='plugin.video.polychromawizard')
dialog = xbmcgui.Dialog()    
VERSION = "0.0.9"
PATH = "polychromawizard"            

    
def CATEGORIES():
    link = OPEN_URL('http://polychroma.co/git/repository.polychroma/txt/wizard.txt').replace('\n','').replace('\r','')
